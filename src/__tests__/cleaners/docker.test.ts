...
describe('DockerCleaner', () => {
  ...
  describe('isAvailable', () => {
    ...
    it('should return true when Docker is installed but server not running', async () => {
      ...
      vi.mocked(execa).mockRejectedValueOnce(new Error('Cannot connect to the Docker daemon'));
  ...
  describe('getCacheInfo', () => {
    ...
    it('should handle Docker command errors gracefully', async () => {
      ...
      vi.mocked(execa).mockRejectedValueOnce(new Error('Docker daemon not running'));
      vi.mocked(execa).mockRejectedValueOnce(new Error('Docker daemon not running'));
