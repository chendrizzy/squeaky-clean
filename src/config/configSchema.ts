...
export const OldConfigSchema = z
  .object({
...
export const NewConfigSchema = z
  .object({
...
export function validateOldConfig(data: unknown): {
  success: boolean;
  data?: OldConfig;
  errors?: string[];
} {
...
export function validateNewConfig(data: unknown): {
  success: boolean;
  data?: NewConfig;
  errors?: string[];
} {
...
export function validateMixedConfig(data: unknown): {
  success: boolean;
  data?: MixedConfig;
  errors?: string[];
} {
